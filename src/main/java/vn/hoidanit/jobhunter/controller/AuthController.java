...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {
        ...
        // set thông tin người dùng đnăg nhập vào context (có thể sử dụng sau này)
        ...
        // create refreshToken
        String refresh_token = this.securityUtil.createRefreshToken(loginDTO.getUsername(), response);
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        // issue a new token/ set refresh token as cookies
        ...
        // create access-token
        String access_token = this.securityUtil.createAccessToken(email, response.getUser());
        response.setAccessToken(access_token);
